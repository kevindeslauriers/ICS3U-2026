...
public class Owner {
    private String name;
    private Dog pet;
    // Constructor (keeps only name and pet)
     ...
     * Postcondition: A message indicating that the owner is walking the dog
     * for the given minutes will be printed.
     */
     ...
     * Postcondition: A message indicating that the owner is feeding the dog
     * and the dog is eating will be printed.
     */
     ...
     * Postcondition: A message indicating that the dog barked the specified
